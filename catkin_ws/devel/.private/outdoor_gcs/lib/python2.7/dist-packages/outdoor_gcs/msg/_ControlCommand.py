...
"""autogenerated by genpy from outdoor_gcs/ControlCommand.msg. Do not edit."""
import codecs
import sys
...
class ControlCommand(genpy.Message):
  ...
  _type = "outdoor_gcs/ControlCommand"
...
float32 roll_ref  ## [rad]"""
  ...
  _slot_types = ['std_msgs/Header','uint32','uint8','outdoor_gcs/TrajectoryPoint']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.Reference_State is None:
        self.Reference_State = outdoor_gcs.msg.TrajectoryPoint()
    else:
      self.header = std_msgs.msg.Header()
      self.Command_ID = 0
      self.Mode = 0
