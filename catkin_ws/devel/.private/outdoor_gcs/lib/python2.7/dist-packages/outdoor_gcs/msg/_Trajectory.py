...
"""autogenerated by genpy from outdoor_gcs/Trajectory.msg. Do not edit."""
import codecs
import sys
...
float32 roll_ref  ## [rad]"""
  ...
  _slot_types = ['std_msgs/Header','outdoor_gcs/TrajectoryPoint[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = outdoor_gcs.msg.TrajectoryPoint()
        _v3 = val1.header
        start = end
        end += 4
