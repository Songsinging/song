...
(cl:defmethod cl:initialize-instance :after ((m <HomePosition>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HomePosition)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name outdoor_gcs-msg:<HomePosition> is deprecated: use outdoor_gcs-msg:HomePosition instead.")))
...
(cl:defmethod geo-val ((m <HomePosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader outdoor_gcs-msg:geo-val is deprecated.  Use outdoor_gcs-msg:geo instead.")
  (geo m))
...
(cl:defmethod orientation-val ((m <HomePosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader outdoor_gcs-msg:orientation-val is deprecated.  Use outdoor_gcs-msg:orientation instead.")
  (orientation m))

(cl:ensure-generic-function 'approach-val :lambda-list '(m))
(cl:defmethod approach-val ((m <HomePosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader outdoor_gcs-msg:approach-val is deprecated.  Use outdoor_gcs-msg:approach instead.")
  (approach m))
