...
(cl:defmethod cl:initialize-instance :after ((m <SinglePayloadAction-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SinglePayloadAction-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name outdoor_gcs-srv:<SinglePayloadAction-request> is deprecated: use outdoor_gcs-srv:SinglePayloadAction-request instead.")))

(cl:ensure-generic-function 'perform_action-val :lambda-list '(m))
(cl:defmethod perform_action-val ((m <SinglePayloadAction-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader outdoor_gcs-srv:perform_action-val is deprecated.  Use outdoor_gcs-srv:perform_action instead.")
  (perform_action m))

(cl:ensure-generic-function 'action_type-val :lambda-list '(m))
(cl:defmethod action_type-val ((m <SinglePayloadAction-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader outdoor_gcs-srv:action_type-val is deprecated.  Use outdoor_gcs-srv:action_type instead.")
  (action_type m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SinglePayloadAction-request>)))
  ...
  "outdoor_gcs/SinglePayloadActionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SinglePayloadAction-request)))
  "Returns string type for a service object of type 'SinglePayloadAction-request"
  "outdoor_gcs/SinglePayloadActionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SinglePayloadAction-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SinglePayloadAction-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name outdoor_gcs-srv:<SinglePayloadAction-response> is deprecated: use outdoor_gcs-srv:SinglePayloadAction-response instead.")))

(cl:ensure-generic-function 'status_ok-val :lambda-list '(m))
(cl:defmethod status_ok-val ((m <SinglePayloadAction-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader outdoor_gcs-srv:status_ok-val is deprecated.  Use outdoor_gcs-srv:status_ok instead.")
  (status_ok m))
...
(cl:defmethod trajectory_type-val ((m <SinglePayloadAction-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader outdoor_gcs-srv:trajectory_type-val is deprecated.  Use outdoor_gcs-srv:trajectory_type instead.")
  (trajectory_type m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SinglePayloadAction-response>)))
  ...
  "outdoor_gcs/SinglePayloadActionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SinglePayloadAction-response)))
  "Returns string type for a service object of type 'SinglePayloadAction-response"
  "outdoor_gcs/SinglePayloadActionResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SinglePayloadAction)))
  ...
  "outdoor_gcs/SinglePayloadAction")