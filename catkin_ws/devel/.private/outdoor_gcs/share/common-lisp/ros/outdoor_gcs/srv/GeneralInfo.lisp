...
(cl:defmethod cl:initialize-instance :after ((m <GeneralInfo-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GeneralInfo-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name outdoor_gcs-srv:<GeneralInfo-request> is deprecated: use outdoor_gcs-srv:GeneralInfo-request instead.")))
...
(cl:defmethod TargetdroneID-val ((m <GeneralInfo-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader outdoor_gcs-srv:TargetdroneID-val is deprecated.  Use outdoor_gcs-srv:TargetdroneID instead.")
  (TargetdroneID m))

(cl:ensure-generic-function 'isMulti-val :lambda-list '(m))
(cl:defmethod isMulti-val ((m <GeneralInfo-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader outdoor_gcs-srv:isMulti-val is deprecated.  Use outdoor_gcs-srv:isMulti instead.")
  (isMulti m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GeneralInfo-request>)))
  ...
  "outdoor_gcs/GeneralInfoRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GeneralInfo-request)))
  "Returns string type for a service object of type 'GeneralInfo-request"
  "outdoor_gcs/GeneralInfoRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GeneralInfo-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GeneralInfo-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name outdoor_gcs-srv:<GeneralInfo-response> is deprecated: use outdoor_gcs-srv:GeneralInfo-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GeneralInfo-response>)))
  ...
  "outdoor_gcs/GeneralInfoResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GeneralInfo-response)))
  "Returns string type for a service object of type 'GeneralInfo-response"
  "outdoor_gcs/GeneralInfoResponse")
