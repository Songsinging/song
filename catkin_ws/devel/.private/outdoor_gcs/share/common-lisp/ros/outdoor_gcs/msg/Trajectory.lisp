...
(cl:defclass <Trajectory> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (points
    :reader points
    :initarg :points
    :type (cl:vector outdoor_gcs-msg:TrajectoryPoint)
   :initform (cl:make-array 0 :element-type 'outdoor_gcs-msg:TrajectoryPoint :initial-element (cl:make-instance 'outdoor_gcs-msg:TrajectoryPoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Trajectory>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Trajectory)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name outdoor_gcs-msg:<Trajectory> is deprecated: use outdoor_gcs-msg:Trajectory instead.")))
...
(cl:defmethod points-val ((m <Trajectory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader outdoor_gcs-msg:points-val is deprecated.  Use outdoor_gcs-msg:points instead.")
  (points m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Trajectory>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'outdoor_gcs-msg:TrajectoryPoint))
