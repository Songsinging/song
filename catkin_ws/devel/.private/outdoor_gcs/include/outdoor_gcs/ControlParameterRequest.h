// Generated by gencpp from file outdoor_gcs/ControlParameterRequest.msg
// DO NOT EDIT!


#ifndef OUTDOOR_GCS_MESSAGE_CONTROLPARAMETERREQUEST_H
#define OUTDOOR_GCS_MESSAGE_CONTROLPARAMETERREQUEST_H
...
struct ControlParameterRequest_
{
  ...
  typedef boost::shared_ptr< ::outdoor_gcs::ControlParameterRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::outdoor_gcs::ControlParameterRequest_<ContainerAllocator> const> ConstPtr;

}; // struct ControlParameterRequest_

typedef ::outdoor_gcs::ControlParameterRequest_<std::allocator<void> > ControlParameterRequest;

typedef boost::shared_ptr< ::outdoor_gcs::ControlParameterRequest > ControlParameterRequestPtr;
typedef boost::shared_ptr< ::outdoor_gcs::ControlParameterRequest const> ControlParameterRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::outdoor_gcs::ControlParameterRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::outdoor_gcs::ControlParameterRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::outdoor_gcs::ControlParameterRequest_<ContainerAllocator1> & lhs, const ::outdoor_gcs::ControlParameterRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::outdoor_gcs::ControlParameterRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::outdoor_gcs::ControlParameterRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::outdoor_gcs::ControlParameterRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::outdoor_gcs::ControlParameterRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::outdoor_gcs::ControlParameterRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::outdoor_gcs::ControlParameterRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::outdoor_gcs::ControlParameterRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::outdoor_gcs::ControlParameterRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xebfb0198b02485c9ULL;
  static const uint64_t static_value2 = 0xa6ec17f0c11eda7aULL;
};

template<class ContainerAllocator>
struct DataType< ::outdoor_gcs::ControlParameterRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::outdoor_gcs::ControlParameterRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::outdoor_gcs::ControlParameterRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::outdoor_gcs::ControlParameterRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::outdoor_gcs::ControlParameterRequest_<ContainerAllocator>& v)
  {
...
#endif // OUTDOOR_GCS_MESSAGE_CONTROLPARAMETERREQUEST_H
