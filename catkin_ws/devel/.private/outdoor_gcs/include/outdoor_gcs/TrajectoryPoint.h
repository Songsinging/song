// Generated by gencpp from file outdoor_gcs/TrajectoryPoint.msg
// DO NOT EDIT!


#ifndef OUTDOOR_GCS_MESSAGE_TRAJECTORYPOINT_H
#define OUTDOOR_GCS_MESSAGE_TRAJECTORYPOINT_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::outdoor_gcs::TrajectoryPoint_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::outdoor_gcs::TrajectoryPoint_<ContainerAllocator> const> ConstPtr;

}; // struct TrajectoryPoint_

typedef ::outdoor_gcs::TrajectoryPoint_<std::allocator<void> > TrajectoryPoint;

typedef boost::shared_ptr< ::outdoor_gcs::TrajectoryPoint > TrajectoryPointPtr;
typedef boost::shared_ptr< ::outdoor_gcs::TrajectoryPoint const> TrajectoryPointConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::outdoor_gcs::TrajectoryPoint_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::outdoor_gcs::TrajectoryPoint_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::outdoor_gcs::TrajectoryPoint_<ContainerAllocator1> & lhs, const ::outdoor_gcs::TrajectoryPoint_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::outdoor_gcs::TrajectoryPoint_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::outdoor_gcs::TrajectoryPoint_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::outdoor_gcs::TrajectoryPoint_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::outdoor_gcs::TrajectoryPoint_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::outdoor_gcs::TrajectoryPoint_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::outdoor_gcs::TrajectoryPoint_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::outdoor_gcs::TrajectoryPoint_<ContainerAllocator> >
{
  ...
  static const char* value(const ::outdoor_gcs::TrajectoryPoint_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2f392e7a4c642edeULL;
  static const uint64_t static_value2 = 0x78d900366dcf5edfULL;
};

template<class ContainerAllocator>
struct DataType< ::outdoor_gcs::TrajectoryPoint_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::outdoor_gcs::TrajectoryPoint_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::outdoor_gcs::TrajectoryPoint_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::outdoor_gcs::TrajectoryPoint_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::outdoor_gcs::TrajectoryPoint_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // OUTDOOR_GCS_MESSAGE_TRAJECTORYPOINT_H
