// Generated by gencpp from file outdoor_gcs/DroneState.msg
// DO NOT EDIT!


#ifndef OUTDOOR_GCS_MESSAGE_DRONESTATE_H
#define OUTDOOR_GCS_MESSAGE_DRONESTATE_H
...
struct DroneState_
{
  ...
  typedef boost::shared_ptr< ::outdoor_gcs::DroneState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::outdoor_gcs::DroneState_<ContainerAllocator> const> ConstPtr;

}; // struct DroneState_

typedef ::outdoor_gcs::DroneState_<std::allocator<void> > DroneState;

typedef boost::shared_ptr< ::outdoor_gcs::DroneState > DroneStatePtr;
typedef boost::shared_ptr< ::outdoor_gcs::DroneState const> DroneStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::outdoor_gcs::DroneState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::outdoor_gcs::DroneState_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::outdoor_gcs::DroneState_<ContainerAllocator1> & lhs, const ::outdoor_gcs::DroneState_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::outdoor_gcs::DroneState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::outdoor_gcs::DroneState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::outdoor_gcs::DroneState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::outdoor_gcs::DroneState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::outdoor_gcs::DroneState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::outdoor_gcs::DroneState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::outdoor_gcs::DroneState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::outdoor_gcs::DroneState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xc76d09f3b60e8a22ULL;
  static const uint64_t static_value2 = 0x4df1768813272926ULL;
};

template<class ContainerAllocator>
struct DataType< ::outdoor_gcs::DroneState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::outdoor_gcs::DroneState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::outdoor_gcs::DroneState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::outdoor_gcs::DroneState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::outdoor_gcs::DroneState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // OUTDOOR_GCS_MESSAGE_DRONESTATE_H
