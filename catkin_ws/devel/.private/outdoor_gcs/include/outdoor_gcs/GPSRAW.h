// Generated by gencpp from file outdoor_gcs/GPSRAW.msg
// DO NOT EDIT!


#ifndef OUTDOOR_GCS_MESSAGE_GPSRAW_H
#define OUTDOOR_GCS_MESSAGE_GPSRAW_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::outdoor_gcs::GPSRAW_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::outdoor_gcs::GPSRAW_<ContainerAllocator> const> ConstPtr;

}; // struct GPSRAW_

typedef ::outdoor_gcs::GPSRAW_<std::allocator<void> > GPSRAW;

typedef boost::shared_ptr< ::outdoor_gcs::GPSRAW > GPSRAWPtr;
typedef boost::shared_ptr< ::outdoor_gcs::GPSRAW const> GPSRAWConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::outdoor_gcs::GPSRAW_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::outdoor_gcs::GPSRAW_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::outdoor_gcs::GPSRAW_<ContainerAllocator1> & lhs, const ::outdoor_gcs::GPSRAW_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::outdoor_gcs::GPSRAW_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::outdoor_gcs::GPSRAW_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::outdoor_gcs::GPSRAW_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::outdoor_gcs::GPSRAW_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::outdoor_gcs::GPSRAW_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::outdoor_gcs::GPSRAW_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::outdoor_gcs::GPSRAW_<ContainerAllocator> >
{
  ...
  static const char* value(const ::outdoor_gcs::GPSRAW_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x386bdffbf0a2d043ULL;
  static const uint64_t static_value2 = 0x6562395d516aa9bdULL;
};

template<class ContainerAllocator>
struct DataType< ::outdoor_gcs::GPSRAW_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::outdoor_gcs::GPSRAW_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::outdoor_gcs::GPSRAW_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::outdoor_gcs::GPSRAW_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::outdoor_gcs::GPSRAW_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // OUTDOOR_GCS_MESSAGE_GPSRAW_H
