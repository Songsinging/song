...
(cl:defmethod cl:initialize-instance :after ((m <RTCM>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RTCM)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f450-msg:<RTCM> is deprecated: use f450-msg:RTCM instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <RTCM>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f450-msg:header-val is deprecated.  Use f450-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <RTCM>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f450-msg:data-val is deprecated.  Use f450-msg:data instead.")
  (data m))
